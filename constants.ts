...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    price: 'от 10 000 ₽',
    basePrice: 10000,
    features: ['1 страница', 'Адаптивный дизайн', 'Форма заявки', 'Интеграция с ботами']
  },
  {
    title: 'Интернет-Магазин',
    price: 'от 70 000 ₽',
    basePrice: 70000,
    features: ['Каталог товаров', 'Корзина и оплата', 'Личный кабинет', 'Интеграция с ботами']
  },
  {
    title: 'Информационная Система',
    price: 'от 100 000 ₽',
    basePrice: 100000,
    features: ['Сложная логика', 'Личные кабинеты', 'Интеграции по API', 'Чат-боты и AI']
  },
  {
    title: 'Чат-боты & AI',
    price: 'от 5 000 ₽',
